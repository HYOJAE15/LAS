...
LABEL_DIR = r'\\172.16.113.151\UOS-SSaS Dropbox\05. Data\02. Training&Test\025. Seoul_Facilities_Corporation\Tancheon-P46-48-Ortho\v0.1.7 - Copy\gtFine\test'
LABEL_SUFFIX = '_gtFine_labelIds.png'

MASK_DIR = r'\\172.16.113.151\UOS-SSaS Dropbox\05. Data\01. Under_Process\025. Seoul Facility Corporation\2023.04.12 Concrete Crack Detection Cascade Mask R-CNN only Positive Samples\v1'
MASK_SUFFIX = '_add_positive.png'

MO_DIR = r'\\172.16.113.151\UOS-SSaS Dropbox\05. Data\01. Under_Process\025. Seoul Facility Corporation\2023.04.12 Concrete Crack Detection Cascade Mask R-CNN only Positive Samples\v1'
MO_SUFFIX = '_mask_output.png'
...
def main():
    ...
    for label_path in label_list:
        ...
        mo_path = os.path.join(MO_DIR, label_name + MO_SUFFIX)
        ...
        mo = cv2.imread(mo_path, cv2.IMREAD_UNCHANGED)
        ...
        intersection = np.logical_and(mask, mo)
