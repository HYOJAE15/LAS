...
parser.add_argument("source_img_folder", help="folder path to images to be cropped", type=str)
...
def main():
    ...
    source_path = args.source_img_folder
    ...
    file_list = glob(os.path.join(source_path, f"*.{source_ext}"))
