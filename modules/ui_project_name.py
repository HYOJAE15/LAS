...
################################################################################
## Form generated from reading UI file 'project_name.ui'
##
...
class Ui_ProjectName(object):
    def setupUi(self, ProjectName):
        if not ProjectName.objectName():
            ProjectName.setObjectName(u"ProjectName")
        ProjectName.resize(560, 350)
        ProjectName.setMinimumSize(QSize(560, 350))
        self.styleSheet = QWidget(ProjectName)
...
"")
        ...
        self.label.setGeometry(QRect(40, 15, 111, 31))
        self.label.setFont(font)
        self.label_2 = QLabel(self.pagesContainer)
        self.label_2.setObjectName(u"label_2")
        self.label_2.setGeometry(QRect(40, 100, 111, 31))
        self.label_2.setFont(font)
        self.selectFolderButton = QPushButton(self.pagesContainer)
        self.selectFolderButton.setObjectName(u"selectFolderButton")
        self.selectFolderButton.setGeometry(QRect(410, 133, 91, 31))
        self.cancelButton = QPushButton(self.pagesContainer)
        self.cancelButton.setObjectName(u"cancelButton")
        self.cancelButton.setGeometry(QRect(410, 185, 91, 31))
        ...
        ProjectName.setCentralWidget(self.styleSheet)
    ...
    def retranslateUi(self, ProjectName):
        ProjectName.setWindowTitle(QCoreApplication.translate("ProjectName", u"MainWindow", None))
        self.titleRightInfo.setText(QCoreApplication.translate("ProjectName", u"<html><head/><body><p><span style=\" font-size:12pt;\">Create New Project - </span><span style=\" font-size:11pt;\">Project Name &amp; Folder</span></p></body></html>", None))
#if QT_CONFIG(tooltip)
        self.minimizeAppBtn.setToolTip(QCoreApplication.translate("ProjectName", u"Minimize", None))
#endif // QT_CONFIG(tooltip)
        self.minimizeAppBtn.setText("")
#if QT_CONFIG(tooltip)
        self.maximizeRestoreAppBtn.setToolTip(QCoreApplication.translate("ProjectName", u"Maximize", None))
#endif // QT_CONFIG(tooltip)
        self.maximizeRestoreAppBtn.setText("")
#if QT_CONFIG(tooltip)
        self.closeAppBtn.setToolTip(QCoreApplication.translate("ProjectName", u"Close", None))
#endif // QT_CONFIG(tooltip)
        self.closeAppBtn.setText("")
        self.label.setText(QCoreApplication.translate("ProjectName", u"<html><head/><body><p><span style=\" font-size:11pt;\">Project Name </span></p></body></html>", None))
